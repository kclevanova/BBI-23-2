...
class Task6 : Task
{
    ...
    public override void ParseText(string text)
    {
        ...
        Console.WriteLine("Сколько слогов в слове");
...
class Task13 : Task
{
    ...
    private void Frqsy(string text)
    {
        ...
        for (int i = 0; i < codes.Length; i++)
        {
            ...
            if (cnt >= 1)
            {
                result += $"На букву {(char)codes[i]} встречается {cnt} раз" + "\n";
            }
        }
    }
